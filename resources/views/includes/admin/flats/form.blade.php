            ...
            <div class="row flex-column  flex-md-row">
                ...
                <div class="col-md-5 col-12">
                    ...
                    <div class="mb-3 col-12 p-0">
                        <input type="file" class="my-3 text-muted @error('image') is-invalid @enderror"
                            id="image" name="image">
                        {{-- MESSAGGIO ERRORE --}}
                        @error('image')
                ...
                <div class="col-md-7 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input id="lat" type="text" placeholder="* Cambo Obbligatorio"
                                    class="form-control" name="latitude" value="{{ old('latitude', $flat->latitude) }}"
                                    hidden>
                            ...
                            <div class="row flex-column flex-sm-row mt-2 justify-content-between">
                                {{-- METRI QUADRI --}}
                                <div class="my-3 col-sm-5 col-12">
                                    ...
                                    @foreach ($services as $service)
                                        <div class="my-2 mr-1 col-sm-3 ">
                                            <input class="mr-0" type="checkbox"
                                                ...
                                                value="{{ $service->id }}">
                                            <label class="form-check-label mx-1" for="{{ $service->label }}">
                                                {{ $service->label }} <i
                    ...
                    <div class="col-12 d-flex flex-column flex-sm-row justify-content-end align-items-center my-5 ">
                        <button type="submit" class="mx-2  my-2 button-71 "
