          ...
          <div class="row">
            ...
            <div class="col-6">
             ...
             <div class="info d-flex mt-4 border align-items-center my-2 p-3">
               ...
               <div class="d-flex justify-content-between mt-1 border py-2"><p class="mx-3 fw-bolder h5 mt-2 mb-0">Prezzo per notte</p><strong class="h3 m-0 ms-2 text-danger mx-3 ">{{ $flat->price_per_day }} €</strong>
               </div>
             ...
             <div class="col-12">
                @if(count($flat->services))<h2 class="mt-3">Servizi</h2> @endif
                <div class="d-flex justify-content-between flex-wrap">
   
               @foreach ($flat->services as $service)
               
                 <p class="mt-2 me-5 w-75"><i class="{{ $service->icon }} fa-2x"></i> {{$service->label }}</p>
